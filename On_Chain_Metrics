...
def main():
    ...
    title_style = "text-align: center; font-family: 'Roboto'; font-weight: bold; color: #000000;"
    st.markdown(f"<h1 style='{title_style}'>On-chain Metrics</h1>", unsafe_allow_html=True)
...
#     search_address = st.sidebar.text_input('Search for Contact by Address', value='0x...')
    ...
    cols_titles = ['Total Users', 'Total Fees Generated', 'Average Value', 'Estimated Profit Margin']
    cols_data = [Metrics.get(table_selection,{}).get('Total Users','NA'), Metrics.get(table_selection,{}).get('Total Fees Generated','NA'), Metrics.get(table_selection,{}).get('Average Value','NA'), Metrics.get(table_selection,{}).get('Estimated Profit Margin','NA')]
